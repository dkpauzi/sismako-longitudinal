...
<body>
    ...
    <div class="no-print">
        <button class="btn-back" onclick="window.close()">Tutup & Kembali</button>
        <button class="btn-back" style="background-color: #0f172a;" onclick="window.print()">Print Ulang</button>
    </div>

    @if(!$isOfficial)
    <div class="alert-banner">
        DOKUMEN INFORMASI AKADEMIK &mdash; Ini merupakan Rapor Bayangan berbasis sistem dan BUKAN Rapor Resmi.
    </div>
    @endif
    ...
    <table class="content-table">
        ...
        <tbody>
            <tr>
                <td colspan="4" style="font-weight: bold; background-color: #f9f9f9 !important; -webkit-print-color-adjust: exact;">Mata Pelajaran Wajib</td>
            </tr>
                    ...
                    <tbody>
                        <tr>
                            <td style="height: 60px; text-align: justify;">
                                {{ $homeroomNotes ?: 'Tingkatkan terus prestasimu, ' . $student->name . '!' }}
                            </td>
                        </tr>
                    </tbody>
                </table>
